<div class="row justify-content-center">
    <div class="col-12">
        <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="fw-bold mb-0">Tambah Pembelian Baru</h3>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4">
                            <label class="form-label fw-bold small text-uppercase text-muted">Keterangan / Catatan Pembelian</label>
                            <textarea name="keterangan" class="form-control bg-light border-0" rows="3" placeholder="Contoh: Barang diterima dalam kondisi baik, garansi 1 tahun..."></textarea>
                        </div>
                    </div>
                </div>

                <!-- Kolom Kanan: Detail Pemasok & Ringkasan -->
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-uppercase text-muted">Nomor Faktur Pembelian</label>
                                <input type="text" class="form-control bg-light border-0 fw-bold" name="no_faktur_pembelian" value="<?php echo $data['no_faktur_pembelian']; ?>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-bold small text-uppercase text-muted">Tanggal Faktur</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="metode_pembayaran" id="metode_pembayaran" class="form-select bg-light border-0" required>
                                    ...
                                    <option value="Kredit">Kredit (Hutang Usaha)</option>
                                </select>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm bg-dark text-white">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between mb-2 align-items-center">
                                <span class="opacity-75">Potongan (Diskon)</span>
                            ...
                            <div class="d-flex justify-content-between align-items-end">
                                ...
                                <h3 class="fw-bold mb-0 text-warning" id="label-total">Rp 0</h3>
                            </div>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary w-100 rounded-pill py-3 mt-4 fw-bold shadow">
                        <i class="bi bi-cart-plus me-2"></i>Simpan Pembelian
                    </button>
                </div>
            </div>
        </form>
